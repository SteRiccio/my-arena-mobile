export default {
  ...
  record: {
    ...
    entity: {
      keyDuplicate: "کلید موجودیت تکراری است",
      keyValueNotSpecified:
        "مقدار کلید برای ویژگی {{keyDefName}} مشخص نشده است",
    },
    nodes: {
      count: {
        invalid: "باید دقیقاً {{count}} مورد باشد",
        maxExceeded: "حداکثر باید {{maxCount}} مورد داشته باشد",
        minNotReached: "حداقل باید {{minCount}} مورد داشته باشد",
      },
    },
  },
};
