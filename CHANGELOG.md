...
- Fixed error fetching records list (iOS);
- Fixed sync data popup menu not appearing in records list;

## [1.2.9] - 2025-02-13

### Added

- Added deprecation warning message. AME will be replaced by Arena Mobile 2 (based on AME);

## [1.2.8] - 2025-01-24

### Fixed

- Fixed numeric/text input focus on node switch (single node view mode);
- Limited top bar breadcrumbs items width;

## [1.2.7] - 2025-01-19

### Added

- Support expressions in min/max count;
...
- Fixed error opening drawer in single-node view when there are empty multiple attributes;
